...
<div class="col-lg-12">
					...
					<div class="form-group">
                        <label class="col-lg-2 control-label">Penjual/Penitip</label>
                        <div class="col-lg-4">
                            <div class="input-group">
					...
					<div class="form-group">
                        <label class="col-lg-2 control-label">Alamat Pemilik</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" disabled>
                        </div>
					...
					<label class="col-sm-2 control-label">Harga Beli</label>
                                <div class="col-lg-4">
                                    <input type="text" placeholder="" data-mask="Rp 999,999,999.99" class="form-control">
                                    <span class="help-inline">Rp 999,999,999.99</span>
                                </div>
					...
					<div class="form-group">
						...
						<label class="col-lg-2 control-label">Faktur Pembelian/Titipan</label>
                        <div class="col-lg-4">
                            <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Warna">
                                                <span class="input-group-btn">
