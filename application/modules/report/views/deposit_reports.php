<div class="row">
            ...
            <div class="panel-body">
                ...
                <div class="adv-table">
                    <table  class="display table table-hover table-bordered table-striped" id="dynamic-table">
                        ...
                        <tbody>
                            <?php $i = 1;
                            foreach ($data_deposit as $purchase) {
                                ?>
    ...
    <script>
        ...
        function lihat_deposit() {
            var from = document.getElementById("from").value;
            var to = document.getElementById("to").value;

            document.location.href = "<?php echo base_url(); ?>report/view_deposit_reports/" + from + "/" + to;
        }

        function cetak_deposit() {
            var from = document.getElementById("from").value;
            var to = document.getElementById("to").value;

            document.location.href = "<?php echo base_url(); ?>report/print_deposit_reports/" + from + "/" + to;
        }
    </script>