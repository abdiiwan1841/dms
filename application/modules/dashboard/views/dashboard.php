                ...
                <div class="top-stats-panel">
                    ...
                    <div class="bar-stats">
                        <ul class="progress-stat-bar clearfix">
							...
							<li data-percent="70%"><span class="progress-stat-percent green"></span></li>
                        </ul>
                        <ul class="bar-legend">
                            <li><span class="bar-legend-pointer pink"></span> Bandung Timur</li>
                            <li><span class="bar-legend-pointer green"></span> Bandung Barat</li>
                            <li><span class="bar-legend-pointer yellow-b"></span> Bandung Selatan</li>
                            <li><span class="bar-legend-pointer green"></span> Bandung Utara</li>
                        </ul>
        ...
        <section class="panel">
            <div class="panel-body">
                <div class="monthly-stats pink">
                    <div class="clearfix">
                        <h4 class="pull-left"> July 2015</h4>
                        <!-- Nav tabs -->
    ...
    <!--div class="col-md-8">
        <div class="event-calendar clearfix">
            ...
            <div class="col-lg-5 event-list-block">
                ...
                <ul class="event-list">
                    <li>Lunch with jhon @ 3:30 <a href="index.html#" class="event-close"><i class="ico-close2"></i></a></li>
                    <li>Coffee meeting with Lisa @ 4:30 <a href="index.html#" class="event-close"><i class="ico-close2"></i></a></li>
                    <li>Skypee conf with patrick @ 5:45 <a href="index.html#" class="event-close"><i class="ico-close2"></i></a></li>
                    <li>Gym @ 7:00 <a href="index.html#" class="event-close"><i class="ico-close2"></i></a></li>
                    <li>Dinner with daniel @ 9:30 <a href="index.html#" class="event-close"><i class="ico-close2"></i></a></li>
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="alert alert-info clearfix">
                ...
                <div class="notification-info">
                    <ul class="clearfix notification-meta">
                        <li class="pull-left notification-sender"><span><a href="index.html#">Jonathan Smith</a></span> send you a mail </li>
            ...
            <div class="alert alert-danger">
                ...
                <div class="notification-info">
                    <ul class="clearfix notification-meta">
                        <li class="pull-left notification-sender"><span><a href="index.html#">Jonathan Smith</a></span> mentioned you in a post </li>
            ...
            <div class="alert alert-success ">
                ...
                <div class="notification-info">
                    ...
                    <p>
                        <a href="index.html#">Anjelina Mewlo, Jack Flip</a> and <a href="index.html#">3 others</a>
                    </p>
                </div>
            </div>
            ...
            <ul class="to-do-list" id="sortable-todo">
                <li class="clearfix">
                    ...
                    <div class="todo-actionlist pull-right clearfix">
                        <a href="index.html#" class="todo-done"><i class="fa fa-check"></i></a>
                        <a href="index.html#" class="todo-edit"><i class="ico-pencil"></i></a>
                        <a href="index.html#" class="todo-remove"><i class="ico-close"></i></a>
                    </div>
                </li>
                <li class="clearfix">
                    <span class="drag-marker">
