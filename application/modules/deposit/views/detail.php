...
<div class="col-lg-12">
  <section class="panel">
    <?php echo form_open('deposit/ubahFaktur','class="form-horizontal form-update-faktur-deposit"')?>
    <header class="panel-heading"> Detail Penitipan </header>
    <div class="panel-body">
      
        <div class="form-group">
          <label class="col-lg-2 control-label">No. Faktur</label>
          <div class="col-lg-4">
              <input type="text" name= "no_faktur" class="form-control" placeholder="No. Faktur" value="<?php echo $data_deposit['no_faktur']?>" readonly required>
          </div>
          <label class="col-lg-2 control-label">Tanggal</label>
          <div class="col-lg-4">
              <input name = "tanggal" type="text" class="form-control form-control-inline input-medium default-date-picker" placeholder="28/07/2015" value="<?php echo $data_deposit['tanggal']?>" required>
          </div>
        </div>
        <div class="form-group">
          <label class="col-lg-2 control-label">Penjual</label>
          <div class="col-lg-4">
          		<?php echo form_dropdown('id_supplier',$data_penjual,$data_deposit['nama_suplier'],'class="form-control" placeholder="Penjual" required');?>
          </div>
          <label class="col-lg-2 control-label">Penanggung Jawab</label>
          <div class="col-lg-4">
          		<?php echo form_dropdown('id_pegawai',$data_pegawai,$data_deposit['nama'],'class="form-control" placeholder="Penanggung Jawab"required');?>
          </div>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="form-group">
         <label class="col-lg-1 control-label">Bayar</label>
          <div class="col-lg-11">
            <input name = "bayar" class="form-control"  size="16" type="text" value="<?php echo $data_deposit['bayar']?>" placeholder="Bayar" required/>
          </div>
        </div>
