  ...
  <body class="login-body">
    ...
    <div class="container">
      ...
      <form class="form-signin" method="post" action="<?php echo base_url();?>dashboard">
		...
		<div class="dealer_logo"><img src="<?php echo base_url();?>assets/images/logo_Adira_Finance.png" width="150px"></div>
		<div class="dealer_details"><h2>Dealer Management System</h2></div>
		</div>
        <div class="login-wrap">
            ...
            <!--label class="checkbox">
                ...
                <span class="pull-right">
                    <a data-toggle="modal" href="<?php echo base_url();?>#myModal"> Reset Password</a>
